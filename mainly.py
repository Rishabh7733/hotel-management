...
class HOTEL_MANAGEMENT:
    def __init__(self):
        ...
        font16 = "-family {Swis721 BlkCn BT} -size 34 -weight bold "  \
        ...
        root.configure(background="#3D3C3A")
        root.configure(highlightbackground="#BCC6CC")
        root.configure(highlightcolor="#BCC6CC")
        ...
        self.Frame1.configure(relief=GROOVE)
        self.Frame1.configure(background="#2B547E")
        self.Frame1.configure(highlightbackground="#BCC6CC")
        self.Frame1.configure(highlightcolor="black")
        self.Frame1.configure(width=10)

        self.Message6 = Message(self.Frame1)
        self.Message6.place(relx=0, rely=0.01, relheight=0.1, relwidth=1.02)
        self.Message6.configure(background="#2B3856")
        self.Message6.configure(font=font16)
        self.Message6.configure(foreground="#F5F5DC")
        self.Message6.configure(highlightbackground="#5E7D7E")
        self.Message6.configure(highlightcolor="black")
        self.Message6.configure(text='''PASSION LIFE''')
        self.Message6.configure(width=850)
